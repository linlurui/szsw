  ...
  <div class="content">
    <el-row class="wrap-main clearfix container">
      ...
      <el-col :span="6" class="wrap-center">
        ...
        <div class="videoInfo">
          <span class="editImg">
            <i class="el-icon-edit-outline" @click="dialogImg=true"></i>
          </span>
          <el-carousel trigger="click" height="6.14rem">
            ...
            <el-carousel-item v-if="imgList.length==0">
              <img src="../../../static/images/XianMuFenCai.jpg">
            </el-carousel-item>
          </el-carousel>
        </div>
    ...
    <up :show="dialogImg" @close="dialogImg=false;getImage()"></up>
  </div>
</template>
<script>
import { setTimeout, setInterval } from 'timers';
import upLoadCarouselImage from '@/base/upLoadCarouselImage'
export default {
  data() {
    return {
      percentage: 70,
      ...
      temp1: '',
      temp2: '',
      dialogImg: false, // 点击上传图片
      imgList: [], // 轮播图列表
    };
  },
  components: {
    up: upLoadCarouselImage
  },
  created() {
    this.header()
    this.getPid()
  ...
  methods: {
    ...
    getImage() {
      this.$axios
        .post(`/api/projectImage/selectProjectImageList?projectId=${this.projectId}&module=1`)
        .then(res => {
          if (res.data.code == 0) {
