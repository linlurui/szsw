        ...
        <div class="box">
          <div class="info">
            ...
            <div class="right">
              ...
              <p style="font-size:0.26rem;margin-top:0.05rem">{{equipmentData.zxElevator?equipmentData.zxElevator:0}}</p>
            </div>
          </div>
        </div>
        <div class="box">
          <div class="info">
            ...
            <div class="right">
              ...
              <p style="font-size:0.26rem;margin-top:0.05rem">{{equipmentData.lxElevator?equipmentData.lxElevator:0}}</p>
            </div>
          </div>
        </div>
        <div class="box">
          ...
          <div class="person" v-show="!equipmentShow">
            ...
            <div class="gongrenInfo">
              ...
              <p style="margin-top:0.2rem">
                ...
                <span style="margin-left:0.2rem" v-if="equipmentData.sbTime">{{equipmentData.sbTime.split(' ')[1]}}</span>
              </p>
            </div>
            <div class="day">
              <div class="bor"></div>
          ...
          <div class="information">
            ...
            <div class="six">
              <div class="box">
                ...
                <div class="two"></div>
                <div class="three">{{equipmentData.record?equipmentData.record.speed:0}}m/s</div>
              ...
              <div class="box">
                ...
                <div class="two">风级：{{equipmentData.record?equipmentData.record.windLevel:0}}级</div>
              ...
              <div class="box">
                ...
                <div class="two"></div>
                <div class="three">{{equipmentData.record?equipmentData.record.floor:0}}楼</div>
                <div class="four" style="background-color:#3ada76;"></div>
              </div>
              <div class="box">
                <div class="one">
                ...
                <div class="two"></div>
                <div class="three">{{equipmentData.record?equipmentData.record.obliguityX:0}}°</div>
                <div class="four" style="background-color:#3ada76;"></div>
              </div>
              <div class="box">
                <div class="one">
                ...
                <div class="two"></div>
                <div class="three">{{equipmentData.record?equipmentData.record.loadingCapacity:0}}人</div>
                <div class="four" style="background-color:#3ada76;"></div>
              </div>
            </div>
            <div class="play">
            ...
            <ul>
              <li style="background-color: #0090ff;">
                ...
                <p class="times">
                  ...
                  <span class="num" v-else>0次</span>
                </p>
              </li>
              <li style="background-color: #3ada76;">
                <p class="name">人数报警</p>
                <p class="times">
                  <span class="num" v-if="equipmentData.rsbj">{{equipmentData.rsbj}}次</span>
                  <span class="num" v-else>0次</span>
                </p>
              </li>
              <li style="background-color: #ffb079;">
                <p class="name">速度报警</p>
                <p class="times">
                  <span class="num" v-if="equipmentData.sdbj">{{equipmentData.sdbj}}次</span>
                  <span class="num" v-else>0次</span>
                </p>
              </li>
              <li style="background-color: #ff7a81;">
                <p class="name">倾斜报警</p>
                <p class="times">
                  <span class="num" v-if="equipmentData.qxbj">{{equipmentData.qxbj}}次</span>
                  <span class="num" v-else>0次</span>
                </p>
              </li>
              <li style="background-color: #ffb079;">
                ...
                <p class="times">
                  <span class="num" v-if="equipmentData.sxwbj">{{equipmentData.sxwbj}}次</span>
                  <span class="num" v-else>0次</span>
                </p>
              </li>
              <li style="background-color: #0090ff;">
                ...
                <p class="times">
                  <span class="num" v-if="equipmentData.xxwbj">{{equipmentData.xxwbj}}次</span>
                  <span class="num" v-else>0次</span>
                </p>
              </li>
              <li style="background-color: #ff7a81;">
                <p class="name">冲顶警报</p>
                <p class="times">
                  <span class="num" v-if="equipmentData.cdbj">{{equipmentData.cdbj}}次</span>
                  <span class="num" v-else>0次</span>
                </p>
              </li>
              <li style="background-color: #3ada76;">
