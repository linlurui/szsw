          ...
          <div class="nav">
            ...
            <div class="scroll-wrap" id="scrollWrap">
              <div class="scroll-inner">
                <a @click="navClick(1)" :class="selectShow==1?'active':''" v-if="stage!=''">模板沉降</a>
                <a @click="navClick(2)" :class="selectShow==2?'active':''" v-if="offset!=''">支架位移</a>
                <a @click="navClick(3)" :class="selectShow==3?'active':''" v-if="subside!=''">立杆轴力</a>
                <!-- <a @click="navClick(4)" :class="selectShow==4?'active':''">支撑轴力</a> -->

                <a @click="navClick(5)" :class="selectShow==5?'active':''" v-if="product!=''">高支模倾斜</a>
            ...
            <div class="data-box">
              ...
              <div class="top-box">
                ...
                <div class="left-box">
                  ...
                  <ul>
                    <!--<li>高支模：<p>{{deviceName}}</p></li>-->
                    <li>高支模：{{deviceName}}</li>
                    <li>最大值：{{stageMaxList.max}}mm</li>
                    <li>最小值：{{stageMaxList.min}}mm</li>
                    <li>平均值：{{stageMaxList.avg}}mm</li>
                  </ul>
                </div>
                <!-- 当日数据趋势图 -->
                ...
                <div class="right-box">
                  <ul>
                    <li>
                      ...
                      <span style="width:2rem;">模板沉降(mm)</span>
              ...
              <div class="table-height">
                ...
                <span style="width:33%;">模板沉降(mm)</span>
          ...
          <div class="main" v-show="selectShow==2&&!historyShow" v-if="offset!=''">
            ...
            <div class="data-box">
              ...
              <div class="top-box">
                ...
                <div class="right-box">
                  <ul>
                    <li>
                      <span style="width:1.4rem;">时间</span>
                      <span style="width:2rem;">位移(mm)</span>
                    </li>
                    <li>
                      <span style="width:1.4rem;">00:00</span>
              ...
              <div class="table-height">
                ...
                <span style="width:25%;">支架位移(mm)</span>
              ...
              <div class="bottom-box">
                <ul>
                  ...
                  >
                    ...
                    <span style="width:25%;">{{item.displacement}}</span>
            ...
            <div class="data-box">
              ...
              <div class="top-box">
                ...
                <div class="left-box">
                  ...
                  <ul>
                    <li>高支模：{{deviceName}}</li>
                    <li>最大值：{{subsideMaxList.max}}kN</li>
                    <li>最小值：{{subsideMaxList.min}}kN</li>
                    <li>平均值：{{subsideMaxList.avg}}kN</li>
                  </ul>
                </div>
                <!-- 当日数据趋势图 -->
              ...
              <div class="bottom-box">
                <ul>
                  ...
                  >
                    ...
                    <span style="width:33%;">{{item.force}}</span>
                    <span style="width:33%;">{{item.creation}}</span>
                  </li>
                  <!-- <li class="even">
                    <span style="width:33%;">JH-01</span>
          ...
          <div class="main" v-show="selectShow==5&&!historyShow" v-if="product!=''">
            ...
            <div class="data-box">
              <div class="table-height">
                <span>检测点</span>
                <span>当日数据趋势图(X)</span>
                <span style="width:2.4rem;">当日数据趋势图(Y)</span>
              </div>
              <div class="top-box">
                <!-- 检测点 -->
                <div class="left-box">
                  ...
                  <ul v-if="productTable.length>0">
                    <li>高支模：{{deviceName}}</li>
                    <li>X方向：{{productTable[productTable.length-1].tiltX}}°</li>
                    <li>Y方向：{{productTable[productTable.length-1].tiltY}}°</li>
                  </ul>
                </div>
                <!-- 当日数据趋势图 -->
              ...
              <div class="table-height">
                <span style="width:25%;">检测点</span>
                <span style="width:25%;">X方向（°）</span>
                <span style="width:25%;">Y方向（°）</span>
                <span style="width:25%;">采集时间</span>
              </div>
              <div class="bottom-box">
                <ul>
              ...
              <div class="table-box" :style="historyTableChange">
                <div class="table-wrap">
                  <el-table :data="stageHistoryTable" stripe border>
                    ...
                    <el-table-column prop="subside" label="模板沉降（mm）"></el-table-column>
                    <!-- <el-table-column>
              ...
              <div class="table-box" :style="historyTableChange">
                <div class="table-wrap">
                  <el-table :data="offsetHistoryTable" stripe border>
                    ...
                    <el-table-column prop="displacement" label="支架位移（mm）"></el-table-column>
                    <el-table-column prop="creation" label="时间"></el-table-column>
                  </el-table>
                  <el-pagination
                    @current-change="handlePageNum"
              ...
              <div class="table-box" :style="historyTableChange">
                <div class="table-wrap">
                  <el-table :data="subsideHistoryTable" stripe border>
                    ...
                    <el-table-column prop="force" label="立杆轴力(kN)"></el-table-column>
                    <el-table-column prop="creation" label="时间"></el-table-column>
                  </el-table>
                  <el-pagination
                    @current-change="handlePageNum"
              ...
              <div class="table-box" :style="historyTableChange">
                <div class="table-wrap">
                  <el-table :data="productHistoryTable" stripe border>
                    ...
                    <el-table-column prop="tiltX" label="X方向（°）"></el-table-column>
                    <el-table-column prop="tiltY" label="Y方向（°）"></el-table-column>
                    <el-table-column prop="creation" label="时间"></el-table-column>
                  </el-table>
                  <el-pagination
                    @current-change="handlePageNum"
  ...
  methods: {
    ...
    getSelectStructure() {
      this.$axios
        ...
        .post(
          `/api/HjGhformworktApi/selectStructure?projectId=${this.projectId}`
        )
        .then(res => {
    ...
    getSelectDisplay() {
      this.$axios
        .post(
          `/api/HjGhformworktApi/selectDisplay?structureId=${this.structureId}`
        )
        .then(res => {
          this.factorList = res.data.data;
          if (this.factorList[0].name == "支架水平位移") {
            this.selectShow = 2;
          } else if (this.factorList[0].name == "高支模倾斜") {
            this.selectShow = 5;
          } else if (this.factorList[0].name == "模板沉降") {
            this.selectShow = 1;
          } else if (this.factorList[0].name == "立杆轴力") {
            this.selectShow = 3;
          }
          ...
          for (let i = 0; i < this.factorList.length; i++) {
            if (this.factorList[i].name == "支架水平位移") {
              this.offset = this.factorList[i].id;
            } else if (this.factorList[i].name == "高支模倾斜") {
              this.product = this.factorList[i].id;
            } else if (this.factorList[i].name == "模板沉降") {
              this.stage = this.factorList[i].id;
            } else if (this.factorList[i].name == "立杆轴力") {
    ...
    getStage(num, size) {
      this.$axios
        .post(
          `/api/HjGhformworktApi/getFactorData?factorId=${
            this.stageListChild
          }&date=${this.nowTime}&pageNum=${num ||
            this.pageNum}&pageSize=${size || this.pageSize}`
        )
        .then(res => {
          if (!size) {
    ...
    getStageFourHoverList() {
      this.$axios
        .post(
          `/api/HjGhformworktApi/selectSpecial?factorId=${this.stageListChild}&date=${this.nowTime}&param=subside`
        )
        .then(res => {
    ...
    getSubsideFourHoverList() {
      this.$axios
        .post(
          `/api/HjGhformworktApi/selectSpecial?factorId=${this.subsideListChild}&date=${this.nowTime}&param=force_r`
        )
        .then(res => {
    ...
    getProductFourHoverList() {
      this.$axios
        .post(
          `/api/HjGhformworktApi/selectSpecial?factorId=${this.productListChild}&date=${this.nowTime}&param=tilt_x`
        )
        .then(res => {
      ...
      this.$axios
        .post(
          `/api/HjGhformworktApi/selectSpecial?factorId=${this.productListChild}&date=${this.nowTime}&param=tilt_y`
        )
        .then(res => {
    ...
    getBiasFourHoverList() {
      this.$axios
        .post(
          `/api/HjGhformworktApi/selectSpecial?factorId=${this.biasListChild}&date=${this.nowTime}&param=tilt_x`
        )
        .then(res => {
      ...
      this.$axios
        .post(
          `/api/HjGhformworktApi/selectSpecial?factorId=${this.biasListChild}&date=${this.nowTime}&param=tilt_y`
        )
        .then(res => {
    ...
    getStageMax() {
      this.$axios
        .post(
          `/api/HjGhformworktApi/getParmeterAvg?displayId=${this.stage}&factorId=${this.stageListChild}`
        )
        .then(res => {
          if (res.data.code == 0) {
    ...
    getSubsideMax() {
      this.$axios
        .post(
          `/api/HjGhformworktApi/getParmeterAvg?displayId=${this.subside}&factorId=${this.subsideListChild}`
        )
        .then(res => {
          if (res.data.code == 0) {
    ...
    getOffsetMax() {
      this.$axios
        .post(
          `/api/HjGhformworktApi/getParmeterAvg?displayId=${this.offset}&factorId=${this.offsetListChild}`
        )
        .then(res => {
          if (res.data.code == 0) {
            this.offsetMaxList = res.data.data;
    ...
    getStageHistory(today) {
      if (today) {
        ...
        this.$axios
          .post(
            `/api/HjGhformworktApi/selectSpecialS?factorId=${this.stageListChild}&startTime=${startTime}&endTime=${endTime}&displayId=${this.stage}`
          )
          .then(res => {
        ...
        this.$axios
          .post(
            `/api/HjGhformworktApi/getFactorDataT?factorId=${this.stageListChild}&startTime=${startTime}&endTime=${endTime}&pageSize=${this.pageSize}&pageNum=${this.pageNum}`
          )
          .then(res => {
            this.stageHistoryTable = res.data.data;
        ...
        this.$axios
          .post(
            `/api/HjGhformworktApi/selectSpecialS?factorId=${this.biasListChild}&startTime=${startTime}&endTime=${endTime}&displayId=${this.stage}`
          )
          .then(res => {
            this.stageHistoryEcharts = res.data;
          });
    ...
    getOffsetHistory(today) {
      if (today) {
        ...
        this.$axios
          .post(
            `/api/HjGhformworktApi/selectSpecialS?factorId=${this.offsetListChild}&startTime=${startTime}&endTime=${endTime}&displayId=${this.offset}`
          )
          .then(res => {
        ...
        this.$axios
          .post(
            `/api/HjGhformworktApi/getFactorDataT?factorId=${this.offsetListChild}&startTime=${startTime}&endTime=${endTime}&pageSize=${this.pageSize}&pageNum=${this.pageNum}`
          )
          .then(res => {
            this.offsetHistoryTable = res.data.data;
    ...
    getSubsideHistory(today) {
      if (today) {
        ...
        this.$axios
          .post(
            `/api/HjGhformworktApi/selectSpecialS?factorId=${this.subsideListChild}&startTime=${startTime}&endTime=${endTime}&displayId=${this.subside}`
          )
          .then(res => {
        ...
        this.$axios
          .post(
            `/api/HjGhformworktApi/getFactorDataT?factorId=${this.subsideListChild}&startTime=${startTime}&endTime=${endTime}&pageSize=${this.pageSize}&pageNum=${this.pageNum}`
          )
          .then(res => {
            this.subsideHistoryTable = res.data.data;
        ...
        this.$axios
          .post(
            `/api/HjGhformworktApi/selectSpecialS?factorId=${this.subsideListChild}&startTime=${startTime}&endTime=${endTime}&displayId=${this.force_r}`
          )
          .then(res => {
            this.subsideHistoryEcharts = res.data;
          });
    ...
    getProductHistory(today) {
      if (today) {
        ...
        this.$axios
          .post(
            `/api/HjGhformworktApi/selectSpecialS?factorId=${this.productListChild}&startTime=${startTime}&endTime=${endTime}&displayId=${this.product}`
          )
          .then(res => {
        ...
        this.$axios
          .post(
            `/api/HjGhformworktApi/getFactorDataT?factorId=${this.productListChild}&startTime=${startTime}&endTime=${endTime}&pageSize=${this.pageSize}&pageNum=${this.pageNum}`
          )
          .then(res => {
            this.productHistoryTable = res.data.data;
    ...
    getBiasHistory(today) {
      if (today) {
        ...
        this.$axios
          .post(
            `/api/HjGhformworktApi/selectSpecialS?factorId=${this.biasListChild}&startTime=${startTime}&endTime=${endTime}&displayId=${this.bias}`
          )
          .then(res => {
        ...
        this.$axios
          .post(
            `/api/HjGhformworktApi/getFactorDataT?factorId=${this.biasListChild}&startTime=${startTime}&endTime=${endTime}&pageSize=${this.pageSize}&pageNum=${this.pageNum}`
          )
          .then(res => {
            this.biasHistoryTable = res.data.data;
    ...
    selectUserAlarms(today) {
      if (today) {
        this.$axios
          .post(
            `/api/HjGhformworktApi/selectUserAlarms?structureId=${this.structureId}&date=${this.nowTime}&pageSize=${this.alarmSize}&pageNum=${this.alarmNum}`
          )
          .then(res => {
        ...
        this.$axios
          .post(
            `/api/HjGhformworktApi/selectUserAlarms?structureId=${this.structureId}&pageSize=100&pageNum=1&date=${this.nowTime.split('-')[0]}`
          )
          .then(res => {
            if (res.data.code == 0) {
    ...
    searchUserAlarms(today) {
      if (today) {
        this.$axios
          .post(
            `/api/HjGhformworktApi/selectUserAlarmsByFactor?factorName=${this.searchValue}&date=${this.nowTime}&pageSize=${this.alarmSize}&pageNum=${this.alarmNum}`
          )
          .then(res => {
        ...
        this.$axios
          .post(
            `/api/HjGhformworktApi/selectUserAlarmsByFactor?factorName=${this.searchValue}&pageSize=${this.alarmSize}&pageNum=${this.alarmNum}&date=${this.nowTime.split('-')[0]}`
          )
          .then(res => {
            this.alarmList = res.data.data.rows;
            this.alarmListTotal = res.data.total;
    ...
    searchStation() {
      ...
      if (this.radio == 1) {
        ...
        if (this.searchValue) {
          ...
          this.$axios
            .post(
              `/api/HjGhformworktApi/selectUserAlarms?structureId=${this.structureId}&pageSize=${this.alarmSize}&pageNum=${this.alarmNum}&date=${this.nowTime.split('-')[0]}`
            )
            .then(res => {
              // debugger
              this.alarmList = res.data.data;
    ...
    getAlarmEchats() {
      this.$axios
        .post(
          `/api/HjGhformworktApi/statisticsAlertor?structureId=${this.structureId}`
        )
        .then(res => {
    ...
    ifCart() {
      ...
      if (this.selectShow == 2 && !this.historyShow) {
        // this.twoChart();
        if (document.getElementById("twoChart") && this.offsetFourHoverListX.length>0) {
          this.twoChart(this.offsetFourHoverListX);
        }
      }
      ...
      if (this.selectShow == 6 && !this.historyShow) {
        if (document.getElementById("slantX") && this.stageFourHoverList.length>0) {
