        ...
        <div class="box">
          <div class="info">
            ...
            <div class="right">
              ...
              <p style="font-size:0.26rem;margin-top:0.05rem">{{equipmentData.countData?equipmentData.countData.number:0}}</p>
            </div>
          </div>
        </div>
        <div class="box">
          <div class="info">
            ...
            <div class="right">
              ...
              <p style="font-size:0.26rem;margin-top:0.05rem">{{equipmentData.countData?equipmentData.countData.off_line:0}}</p>
            </div>
          </div>
        </div>
        <div class="box">
          <div class="info">
            ...
            <div class="right">
              ...
              <p style="font-size:0.26rem;margin-top:0.05rem">{{equipmentData.countData?equipmentData.countData.count.awarmCount+equipmentData.countData.count.bwarmCount+equipmentData.countData.count.cwarmCount+equipmentData.countData.count.nwarmCount+equipmentData.countData.count.currentCount+equipmentData.countData.count.envirwarmCount:0}}</p>
            </div>
          </div>
        </div>
      </div>
      <div id="down">
        <div id="right">
          <div class="information">
            ...
            <div class="quan">
              <p class="num">{{equipmentData.new?equipmentData.new.data.current:0}}kw</p>
              <p class="text">漏电</p>
            </div>
            <div class="six">
              <div class="box">
                ...
                <div class="two"></div>
                <div class="three">{{equipmentData.new?equipmentData.new.data.awarm:0}}℃</div>
              ...
              <div class="box">
                ...
                <div class="two"></div>
                <div class="three">{{equipmentData.new?equipmentData.new.data.bwarm:0}}℃</div>
              ...
              <div class="box">
                ...
                <div class="two"></div>
                <div class="three">{{equipmentData.new?equipmentData.new.doorLock:'无数据'}}</div>
              ...
              <div class="box">
                ...
                <div class="two"></div>
                <div class="three">{{equipmentData.new?equipmentData.new.data.cwarm:0}}℃</div>
                <div class="four" style="background-color:#3ada76;"></div>
              </div>
              <div class="box">
                <div class="one">
                ...
                <div class="two"></div>
                <div class="three">{{equipmentData.new?equipmentData.new.data.nwarm:0}}℃</div>
                <div class="four" style="background-color:#3ada76;"></div>
              </div>
              <div class="box">
                <div class="one">运行状态</div>
                <div class="two"></div>
                <div class="three">{{equipmentData.new?equipmentData.new.runningStatus:'无数据'}}</div>
                <div class="four" style="background-color:#3ada76;"></div>
              </div>
            </div>
          </div>
          <div class="all">
            ...
            <ul>
              <li style="background-color: #0090ff;">
                ...
                <p class="times">
                  <span class="num">{{equipmentData.countData?equipmentData.countData.count.envirwarmCount:0}}次</span>
                </p>
              </li>
              <li style="background-color: #3ada76;">
                <p class="name">漏电报警</p>
                <p class="times">
                  <span class="num">{{equipmentData.countData?equipmentData.countData.count.currentCount:0}}次</span>
                </p>
              </li>
              <li style="background-color: #ffb079;">
                <p class="name">A相温度报警</p>
                <p class="times">
                  <span class="num">{{equipmentData.countData?equipmentData.countData.count.awarmCount:0}}次</span>
                </p>
              </li>
              <li style="background-color: #ffb079;">
                <p class="name">B相温度报警</p>
                <p class="times">
                  <span class="num">{{equipmentData.countData?equipmentData.countData.count.bwarmCount:0}}次</span>
                </p>
              </li>
              <li style="background-color: #0090ff;">
                <p class="name">C相温度报警</p>
                <p class="times">
                  <span class="num">{{equipmentData.countData?equipmentData.countData.count.cwarmCount:0}}次</span>
                </p>
              </li>
              <li style="background-color: #ff7a81;">
                <p class="name">N相温度报警</p>
                <p class="times">
                  <span class="num">{{equipmentData.countData?equipmentData.countData.count.nwarmCount:0}}次</span>
                </p>
              </li>
            </ul>
          </div>
